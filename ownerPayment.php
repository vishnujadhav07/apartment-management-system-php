    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ownerPayment.php">Payment</a>
          </li>
          <li class="nav-item">
    ...
    <table class="table mt-4" id="pay">
      <tbody>
        ...
        while ($row1 = mysqli_fetch_array($r1)) {
            echo '<tr>  <td>' . $row1['bid'] . '</td> <td>' . $row1['aid'] . '</td> <td>' . $row1['name'] . '</td> <td>' . $row1['paid_date'] . '</td> <td>' . $row1['rent'] . '</td> </tr>';
        }
        ?>
      </tbody>
    </table>
  ...
  <footer class="footer footer-distributed sticky-bottom">
    ...
    <div class="footer-left">
      ...
      <p class="footer-links">
        <a class="link-1" href="ownerHome.php">Tenant Home</a>
        <a href="ownerPayment.php">Payments</a>
      </p>
