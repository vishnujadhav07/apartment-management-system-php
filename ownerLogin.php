...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($count == 1) {
    ...
    echo "window.location='ownerHome.php'";
    echo "</script>";;
  }
}
?>
  ...
  <div class="content inside_form" id="owner">
    <div class="overlay">
      <form action="" name="myForm" method="post">
        ...
        <div class="mb-3">
          <label class="form-label" for="email">OWNER ID</label>
          <input class="form-control" type="text" id="email" placeholder="Owner id" name="email" required>
        </div>
        <div class="mb-3">
          <label class="form-label" for="pass">PASSWORD</label>
          <input class="form-control" type="password" minlength="8" id="pass" placeholder="Password" name="pass" required>
        </div>
        <div class="mb-3">
