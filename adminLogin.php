...
<body>
  ...
  <div class="content inside_form" id="admin">
    <div class="overlay">
      <form action="" name="myForm" method="post">
        ...
        <div class="mb-3">
          <label class="form-label" for="email">ADMIN ID</label>
          <input class="form-control" type="text" id="email" placeholder="Admin ID" name="email" required>
        </div>
        <div class="mb-3">
  ...
  <footer class="footer footer-distributed sticky-bottom">
    ...
    <div class="footer-right">
      ...
      <a href="mailto:raurakshith.cs21@rvce.edu.in"><i class="fas fa-envelope"></i></a>
      <a href="6363456218"><i class="fa fa-phone"></i></a>
