...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($count == 0) {
    $sql = "INSERT into apartment ( id, bid, apart_num, description) VALUES ( $aid ,$bname, $num, '$des')";
    $result = mysqli_query($db, $sql);
...
<body>
  ...
  <div class="content container" style="text-align:center;">
    ...
    <form method="post" class="form-add-building">
      ...
      <div class="row mb-3">
        <label for="aid" class="col-sm-3 col-form-label">Apartment ID</label>
        <div class="col-sm-9">
          <input type="int" class="form-control" id="aid" name="aid" required>
