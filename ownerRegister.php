  ...
  if ($count == 0) {
    ...
    if ($count2 == 0) {
      ...
      echo "<script language=\"JavaScript\">\n";
        echo "alert('Owner added Succesfully');";
        echo "window.location='addBuilding.php'";
        echo "</script>";
...
<body>
  ...
  <div class="content container" style="text-align:center;">
    ...
    <form action="" method="post" class="form-add-owner">
      ...
      <div class="row mb-3">
        <label for="email" class="col-sm-3 col-form-label">Owner ID</label>
        <div class="col-sm-9">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-9">
          <input type="password" class="form-control" minlength="8" id="pass" name="pass" <?php
